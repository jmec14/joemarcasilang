...
<html <?php language_attributes(); ?>>
  ...
  <body <?php body_class(); ?>>
  	...
  	<?php 
	if ( function_exists( 'travely_contact_info' ) ) {
		travely_contact_info(); 
	}?>
	...
	<div class="travely-banner-area">
		...
		<?php if( is_front_page() ) :
				...
				if ( $banner_type == 'video' && is_front_page() ) :
					travely_banner_video();
				elseif ( $banner_type == 'carousel' && is_front_page() ) :
					travely_banner_slider();
				else :
					travely_banner_background();
				endif;
			else : ?>
			<div class="header-background other-header">
				...
				<div class="header-content other">
					...
					<div class = "breadcrumb" ><?php if (class_exists('WooCommerce')){
							( (is_woocommerce())? woocommerce_breadcrumb() : travely_get_breadcrumb() );
						}else{
							travely_get_breadcrumb();
						}?>
					</div>
					<?php endif; ?>
				</div>
